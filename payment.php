...
$result = mysqli_query($conn, "SELECT * FROM payment WHERE HOUSE_ID = '$HOUSE_ID'"); // using mysqli_query instead
?>
...
<div class="main">
<div>
<a style="float: left;font-size:20px;" href="houseslist.php" >Back to List of Houses</a>
<a style="float: right;font-size:20px;" target="_blank" class='recordsbutton' href="<?php echo "generatepayment.php?HOUSE_ID=$HOUSE_ID"; ?>" >Generate PDF</a><br/><br/>
</div>
<h1 align="center"> Payment List for <?php echo $HOUSE_ID ?></h1>
	...
	<tr bgcolor='#CCCCCC'>
		...
		<td style="font-size:20px; font-weight:bold;border-top: 1px solid black; border-bottom: 1px solid black; border-left: 1px solid black;border-right: 1px solid black;">Payment Date (Key-in Date)</td>
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td style='font-size: 20px; padding-left:5px; border-bottom: 1px solid black;border-left: 1px solid black;border-right: 1px solid black;'><a class='deletebutton' style='text-decoration: none;' href=\"deletepayment.php?ID=$res[ID]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";		
		echo "";	
	}
	?>
	</table>
